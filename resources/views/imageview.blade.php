...
<div>
<h2><img src = "/storage/{{$ambulance->img}}" style="width:400px;height:400px;" alt="Not Uploaded"></h2>
</div>

<div class="mt-4 ml-4" >
<h2><img src = "/storage/{{$ambulance->img2}}" style="width:400px;height:400px;"  alt="Not Uploaded"></h2>
</div>

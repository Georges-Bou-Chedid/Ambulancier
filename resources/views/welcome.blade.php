...
<div class="mt-6 flex items-center px-4">
    <div class='overflow-x-auto w-full'>

<div class="mt-6 mx-auto max-w-4xl w-full rounded-lg divide-y divide-gray-300 overflow-hidden">
  ...
  Add Request +
        ...
        <!-- Table -->
        <table class='mt-6 mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden'>

...
@section('content')
      ...
      <div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh;">
        <div class="absolute top-0 w-full h-full bg-center bg-cover" style="background-image: url('/images/Digital-Marketing.jpg');">
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-gray-300">
                  Welcome To Tasks , if you don't have an account.
                  Please Sign up to have Permission.
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="pb-20 bg-gray-300 -mt-24">
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap">
            ...
            <div class="pt-8 md:w-4/12 m-auto text-center">
              <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Services</h6>
